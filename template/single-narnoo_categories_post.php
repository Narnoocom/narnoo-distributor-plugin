			            ...
			            <div class="col-md-5">
			            	...
			            	<div class="product-information-data">
			            		<?php if(!empty($businessname)): ?>
									<div class="row">
										<div class="col-md-5 col-sm-5"><label> Business Name:</label></div>
										<div class="col-md-7 col-sm-7"><?php echo $businessname; ?></div>
									</div>
						    	<?php endif; ?>

						    	<?php if(!empty($businessphone)): ?>
									<div class="row">
										<div class="col-md-5 col-sm-5"><label> Business Phone:</label></div>
										<div class="col-md-7 col-sm-7"><?php echo $businessphone ?></div>
									</div>
						    	<?php endif; ?>

						    	<?php if(!empty($businessurl)): ?>
									<div class="row">
										<div class="col-md-5 col-sm-5"><label> Business URL:</label></div>
