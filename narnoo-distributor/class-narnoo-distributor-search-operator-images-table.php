<?php
/**
 * Narnoo Distributor - Search Operator Images table.
 **/
class Narnoo_Distributor_Search_Operator_Images_Table extends Narnoo_Distributor_Search_Operator_Media_Table {
	public $search_operator_media_type = 'image';
