<?php
/**
 * Narnoo Operator - Search Brochures table.
 **/
class Narnoo_Distributor_Search_Brochures_Table extends Narnoo_Distributor_Search_Media_Table {
	public $search_media_type = 'brochure';
