<?php
/**
 * Narnoo Operator - Search Operator Videos table.
 **/
class Narnoo_Distributor_Search_Operator_Videos_Table extends Narnoo_Distributor_Search_Operator_Media_Table {
	public $search_operator_media_type = 'video';
